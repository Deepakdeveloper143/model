...
run_quantized.py
----------------
Load the small (quantised) model we saved earlier and chat with it.

Run it:  python run_quantized.py
"""
...
question = "What is AI? Answer in 3 short sentences."
